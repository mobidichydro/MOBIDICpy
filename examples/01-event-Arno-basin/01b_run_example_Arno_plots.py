...
It is required to run 01a_run_example_Arno.py first to generate the output files.
...
def main():
    ...
    matlab_dir = Path(__file__).parent.parent / "datasets" / "Arno" / "matlab_output" / "Arno_event_Nov_2023"
